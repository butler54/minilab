...
| `datasource` | Platform Thanos global datasource | Existing `thanos-querier` PersesGlobalDatasource |
...
**Relationship**: The namespace label enables the existing ServiceMonitor; no second ServiceMonitor is created. The platform Thanos datasource supplies both platform-health and LVMS-capacity series to the dashboard.
